...
| `ADMIN_DEFAULT_PASSWORD` | **Yes (for seeding)** | `<your-secure-admin-password>` | Secret password required in production when executing `npm run seed:admin`. Code default fallback is strictly rejected in production. |
